...
KEY_ACTIONS = [
    ...
    ("favorite_toggle", "Favorite / unfavorite"),
    ("kids_view_toggle", "Kids card/compact view"),
    ("profile_cycle", "Cycle user profile"),
    ...
    ("youtube_cache_now", "Cache YouTube episode/season/show now"),
    ("zoom_toggle", "Toggle YouTube pillarbox zoom"),
    ("set_thumbnail", "Set show thumbnail from frame"),
...
DEFAULT_KEYMAP: dict[str, list[int]] = {
    ...
    "favorite_toggle": [pygame.K_f],
    "kids_view_toggle": [pygame.K_v],
    "profile_cycle": [pygame.K_p],
    "key_config": [pygame.K_F2],
    "gamepad_config": [pygame.K_F4],
    "safe_zone": [pygame.K_z],
    "cache_cancel": [pygame.K_c],
    "youtube_cache_now": [pygame.K_y],
    "zoom_toggle": [pygame.K_t],
    "set_thumbnail": [pygame.K_i],
    "next_episode": [pygame.K_PAGEDOWN],
    "prev_episode": [pygame.K_PAGEUP],
    "stop_clear": [pygame.K_BACKSPACE],
